...
public class IceCreamContract {
    ...
    public static final String AUTHORITY = "com.icypicks.www.icypicks";
    private static final Uri BASE_CONTENT_URI = Uri.parse("content://" + AUTHORITY);
    public static final String PATH_ICE_CREAM = IceCreamEntry.TABLE_NAME;
    ...
    public static final class IceCreamEntry implements BaseColumns{
        ...
        public static final String TABLE_NAME = "must_try_ice_creams";
